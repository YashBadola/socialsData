...
def test_load_soren_kierkegaard_dataset():
    ...
    expected_sources = {"selections.txt"}
    ...
    # Note: The text includes a lot of Project Gutenberg license info, but also the content.
    # We should search for keywords likely to be in the content.
    keywords = ["Kierkegaard", "faith", "anxiety", "paradox", "Abraham", "Isaac", "Either/Or"]
