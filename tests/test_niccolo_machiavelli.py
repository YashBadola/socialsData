...
def test_load_niccolo_machiavelli_dataset():
    """Test that the Niccolò Machiavelli dataset can be loaded and contains valid data."""
    ...
    expected_sources = {"the_prince.txt"}
    ...
    keywords = ["prince", "virtue", "fortune", "power", "state", "Duke"]
...
if __name__ == "__main__":
    test_load_niccolo_machiavelli_dataset()
