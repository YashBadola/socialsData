...
def test_load_michel_foucault_dataset():
    ...
    expected_sources = {"panopticism.txt"}

    # Since we only have one source file, we expect it to be present.
    # The dataset loader might split it, but the source name should remain.
    ...
    keywords = ["Panopticon", "power", "knowledge", "bodies", "surfaces"]
