...
def test_load_aristotle_dataset():
    ...
    # Ensure the path logic works by installing the package or just by setting PYTHONPATH.
    # The tests seem to rely on socials_data being installed or in path.
    ...
    keywords = ["virtue", "political animal", "good", "city", "mean"]
