...
def test_load_aristotle_dataset():
    ...
    # We expect all sources to be present since we have enough text in each.
    # But just in case of chunking, we check if at least some are there and no unknown sources.
    ...
    keywords = ["virtue", "political", "state", "nature", "cause", "imitation", "art"]
