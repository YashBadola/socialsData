...
def test_workflow():
    ...
    # We added new content, so now there should be 6 items (5 original + 1 added)
    ...
    assert "Machinic desire" in all_text_land
    ...
    assert "horror of Communism" in all_text_zizek
