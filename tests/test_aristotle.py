...
def test_load_aristotle_dataset():
    ...
    # We check that sources match exactly or are a subset if processing chunked it differently,
    # but here we expect full files processed.
    ...
    keywords = ["virtue", "happiness", "political", "tragedy", "imitation", "mean"]
