...
def test_load_aristotle_dataset():
    ...
    # We should have at least one item from each source if the processing works correctly
    # and if we have provided enough data.
    # The processor seems to create one entry per file if not chunked otherwise.
    # Let's verify we have all sources present.
    ...
    keywords = ["virtue", "politics", "metaphysics", "imitation", "nature"]
