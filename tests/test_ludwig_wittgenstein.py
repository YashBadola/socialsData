...
def test_load_ludwig_wittgenstein_dataset():
    ...
    expected_sources = {"tractatus_excerpt.txt", "investigations_excerpt.txt"}

    # We expect exactly these sources since I created them manually and explicitly
    ...
    keywords = ["world", "fact", "language", "game", "meaning", "use", "Excalibur"]
