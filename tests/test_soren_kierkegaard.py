...
def test_load_soren_kierkegaard_dataset():
    ...
    expected_sources = {"fear_and_trembling_excerpts.txt", "either_or_excerpts.txt", "in_vino_veritas_excerpts.txt"}
    ...
    keywords = ["Abraham", "faith", "poet", "melancholy", "seducer", "banquet", "love", "contradiction"]
