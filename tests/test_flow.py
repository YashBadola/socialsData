...
def test_workflow():
    ...
    # We added new content, so now there should be at least 5 items (likely more due to chunking)
    ...
    # We added new content, so now there should be at least 5 items
    ...
    # We added new content, so now there should be at least 3 items
