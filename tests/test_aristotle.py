...
def test_load_aristotle_dataset():
    ...
    expected_sources = {"nicomachean_ethics.txt", "politics.txt", "poetics.txt", "metaphysics.txt"}
    ...
    keywords = ["virtue", "political animal", "tragedy", "metaphysics", "Eudaimonia", "golden mean"]
