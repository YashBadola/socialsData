...
def test_diogenes_metadata():
    ...
    # Check sources if you added any
    assert "Lives of the Eminent Philosophers by Diogenes Laertius" in [s["title"] for s in metadata["sources"]]
...
def test_qa_file_exists_and_valid():
    ...
    with open(qa_path, 'r') as f:
        ...
        assert "Diogenes" in first_entry["instruction"] or "Diogenes" in first_entry["response"] or "King" in first_entry["instruction"]
