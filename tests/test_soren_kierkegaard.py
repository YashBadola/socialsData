...
def test_load_soren_kierkegaard_dataset():
    ...
    # Check that we have at least these sources (or subsets thereof depending on chunking, but here files are small)
    ...
    keywords = ["Abraham", "boredom", "faith", "paradox", "poet"]
