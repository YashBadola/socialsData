...
class PersonalityManager:
    def __init__(self, base_dir=None):
        ...
        self.db = Database()
        self.db.init_db()
        self._sync_personalities_to_db()

    def _sync_personalities_to_db(self):
        """Syncs file-based personalities to the SQLite database."""
    ...
    def get_metadata(self, personality_id):
        ...
        if not path.exists():
            # Fallback to DB if file is missing (unlikely given current setup but good for robustness)
