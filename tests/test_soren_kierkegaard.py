...
def test_load_soren_kierkegaard_dataset():
    ...
    expected_sources = {"selections_from_writings.txt"}
    ...
    # Since we used the Selections book, we expect some of these to be present.
    keywords = ["Abraham", "Isaac", "Sarah", "faith", "infinite", "resignation"]
