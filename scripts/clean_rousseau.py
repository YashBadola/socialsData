...
def clean_gutenberg_text(filepath):
    ...
    # These need to be robust enough for different Gutenberg variations
    start_patterns = [
    ...
    # Additional cleanup: remove multiple newlines to just double newlines?
    # No, the processor handles that if needed. We just want to strip the license headers.
