...
def test_dataset_content_ludwig_wittgenstein():
    ...
    # Check for keywords relevant to Tractatus
    keywords = ["proposition", "logic", "language", "silence", "fact", "object", "picture", "world"]
...
def test_metadata_ludwig_wittgenstein():
    ...
    assert "aphorism" in metadata["system_prompt"].lower()
