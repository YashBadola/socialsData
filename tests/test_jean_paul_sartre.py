...
def test_load_jean_paul_sartre_dataset():
    ...
    expected_sources = {"existentialism_is_a_humanism.txt"}

    # Check that sources match expected
    ...
    keywords = ["existentialism", "humanism", "freedom", "responsibility", "essence", "anguish"]
