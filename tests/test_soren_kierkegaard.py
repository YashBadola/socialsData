...
def test_load_kierkegaard_dataset():
    ...
    # Note: source field is present in our data, but load_dataset might filter it?
    # Based on test_plato.py, source is expected.
