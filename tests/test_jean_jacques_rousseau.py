...
def test_load_dataset_rousseau():
...
def test_dataset_content_rousseau():
    """Test content of the Rousseau dataset."""
    dataset = load_dataset("jean_jacques_rousseau")

    # Check for keywords
    keywords = ["nature", "freedom", "chains", "contract", "education", "inequality"]
...
def test_metadata_rousseau():
    """Test metadata for Rousseau."""
