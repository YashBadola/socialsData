...
def test_load_kierkegaard_dataset():
    ...
    # We expect all sources to be present since we have very few files
    ...
    keywords = ["Knight of Faith", "paradox", "universal", "aesthete", "boredom"]
    ...
    for k, found in found_keywords.items():
        assert found, f"Did not find expected keyword '{k}' in the dataset"
