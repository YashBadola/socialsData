...
def test_load_aristotle_dataset():
    ...
    # We expect all sources to be present since we have enough data and it's small enough to process fully
    ...
    keywords = ["virtue", "happiness", "state", "metaphysics", "poetry", "imitation", "nature"]
