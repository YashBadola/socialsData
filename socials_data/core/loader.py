...
def load_dataset(personality_id, split="train", type="text"):
    """
    ...
    Args:
        ...
        type (str): The type of data to load. "text" for raw text, "qa" for Q&A pairs.

    Returns:
        Dataset: A Hugging Face Dataset object.
    """
    filename = "qa.jsonl" if type == "qa" else "data.jsonl"
