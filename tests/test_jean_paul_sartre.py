...
def test_load_sartre_dataset():
    ...
    expected_sources = {"existentialism_excerpts.txt"}

    # We expect our specific source to be there
    ...
    keywords = ["existentialism", "essence", "responsibility", "Bad Faith", "condemned to be free"]
