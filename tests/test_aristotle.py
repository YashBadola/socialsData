...
def test_load_aristotle_dataset():
    ...
    keywords = ["virtue", "political animal", "metaphysics", "imitation", "happiness", "mean"]
    found_keywords = False

    # Just check if at least one keyword is found across the whole dataset (which is small)
